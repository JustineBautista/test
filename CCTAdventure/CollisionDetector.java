...
public class CollisionDetector {
    ...
    public int checkObject(entity.Entity entity, boolean isPlayer) {
        int index = 999;
    ...
    public int checkEntity(entity.Entity entity, Asset[][] targets) {
    ...
    private void checkFutureMovement(entity.Entity entity) {
        switch (entity.getDirection()) {
