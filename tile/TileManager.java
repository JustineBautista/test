...
public class TileManager {
    ...
    public TileManager(GamePanel gamePanel) {
        ...
        getTileImage();
        loadMap("/maps/worldV3.txt", 2);
        loadMap("/maps/interior01.txt", 3);
    ...
    public void getTileImage() {
		...
		setup(45, "black", true);
		setup(46, "wall(1)", true);
		setup(47, "window", true);
		setup(48, "floor", false);
		setup(49, "bottom_left_corner", true);
		setup(50, "bottom_right_corner", true);
		setup(51, "bottom_wall", true);
		setup(52, "top_wall", true);
		setup(53, "left_wall", true);
		setup(54, "right_wall", true);
		setup(55, "grass(2)", true);
		setup(56, "path", false);
		setup(57, "tree(1)", true);
		setup(58, "water", true);
		setup(59, "sand", false);
		setup(60, "basta", false);
		setup(61, "bricks", true);
		setup(62, "red_path", false);
		setup(63, "road(1)", false);
		setup(64, "road(2)", false);
		setup(65, "road(3)", false);
		setup(66, "black", false);
		setup(67, "grass(3)", true);
		setup(68, "red_path(1)", true);
    }
