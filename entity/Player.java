...
import CCTAdventure.Asset;
import CCTAdventure.GamePanel;
import CCTAdventure.KeyHandler;
...
import objects.PickUpOnlyObject;
...
public class Player extends Entity {
    ...
    public void setDefaultPosition() {
        ...
        setWorldY(getGamePanel().getTileSize() * 24);
        setDirection("down");
    }
    ...
    private void setCollision() {
        setCollisionArea(new Rectangle(10, 16, 32, 32));
    ...
    public void getAnimationImages() {
        setUp1(setup("/player/back(1)", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
        setUp2(setup("/player/back(2)", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
        setDown1(setup("/player/front(1)", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
        setDown2(setup("/player/front(2)", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
        setLeft1(setup("/player/left(1)", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
        setLeft2(setup("/player/left(2)", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
        setRight1(setup("/player/right(1)", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
        setRight2(setup("/player/right(2)", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
    }

    public void getAttackImages() {
        if (getCurrentWeapon() instanceof OBJ_Sword_Normal) {
            setAttackUp1(setup("/player/boy_attack_up_1", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackUp2(setup("/player/boy_attack_up_2", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackDown1(setup("/player/boy_attack_down_1", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackDown2(setup("/player/boy_attack_down_2", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackLeft1(setup("/player/boy_attack_left_1", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackLeft2(setup("/player/boy_attack_left_2", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackRight1(setup("/player/boy_attack_right_1", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackRight2(setup("/player/boy_attack_right_2", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
        }

        if (getCurrentWeapon() instanceof OBJ_Axe) {
            setAttackUp1(setup("/player/boy_axe_up_1", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackUp2(setup("/player/boy_axe_up_2", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackDown1(setup("/player/boy_axe_down_1", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackDown2(setup("/player/boy_axe_down_2", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackLeft1(setup("/player/boy_axe_left_1", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackLeft2(setup("/player/boy_axe_left_2", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackRight1(setup("/player/boy_axe_right_1", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackRight2(setup("/player/boy_axe_right_2", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
        }
    }
